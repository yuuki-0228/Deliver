...
#include "..\..\Common.h"
#include "..\..\..\Object\Light\MeshPointLight\MeshPointLight.h"
...
public:
	...
	struct CBUFFER_PER_FRAME
	{
		...
		D3DXVECTOR4		vPointLightBrightness;	// メッシュに対してのポイントライトの強弱.
...
public:
	...
	// メッシュポイントライトの設定.
	void SetMeshPointLight( const SMeshPointLight& Light ) {
		m_PointLightIntensity	= Light.Intensity;
		m_PointLightBrightness	= Light.Brightness;
	}
...
private:
	...
	float					m_PointLightIntensity;			// メッシュに対してのポイントライトの強さ.
	float					m_PointLightBrightness;			// メッシュに対してのポイントライトの明るさ.
