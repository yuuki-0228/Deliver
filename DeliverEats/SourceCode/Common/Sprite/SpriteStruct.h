...
struct stSpriteAnimState
{
	...
	bool			IsSetPatternNo;			// パターンNoを設定するか.
...
struct stSpriteRenderState
{
	...
	ID3D11ShaderResourceView*	pMaskTexture;		// マスク画像.
	ID3D11ShaderResourceView*	pRuleTexture;		// ルール画像.
